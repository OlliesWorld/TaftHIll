    ...
    <div className="Slider">
      <AliceCarousel autoPlay autoPlayInterval="2500">
        ...
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          ...
          <div className="intro-text left-0 text-center bg-secondary p-5 rounded">
            <p className="text-primary mt-5 mb-3">
        ...
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          ...
          <h2 className="section-heading mb-4">
            <span className="section-heading-upper">~Samantha</span>
          </h2>
        </div>
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          <p className="mb-3">
        ...
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          ...
          <h2 className="section-heading mb-4">
            <span className="section-heading-upper">~Courtney</span>
          </h2>
        </div>
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          <p className="mb-3">
        ...
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          ...
          <h2 className="section-heading mb-4">
            <span className="section-heading-upper">~Hannah</span>
          </h2>
        </div>
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          <p className="mb-3">
        ...
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          ...
          <h2 className="section-heading mb-4">
            <span className="section-heading-upper">~August</span>
          </h2>
        </div>
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          <p className="mb-3">
        ...
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          ...
          <h2 className="section-heading mb-4">
            <span className="section-heading-upper">~Sarah</span>
          </h2>
        </div>
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          <p className="mb-3">
        ...
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          ...
          <h2 className="section-heading mb-4">
            <span className="section-heading-upper">~Sheila</span>
          </h2>
        </div>
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          <p className="mb-3">
        ...
        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
          ...
          <h2 className="section-heading mb-4">
            <span className="section-heading-upper">~Kristie</span>
          </h2>
        </div>
      </AliceCarousel>
    </div>
